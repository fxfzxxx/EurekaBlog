...
function createBirthday() {
  ...
  btn.addEventListener("click", function () {
    ...
    p.innerHTML = `
         ...
         <p><span>
            </span><span>很多记忆历历在目，虽然有些暗淡无光，然我们发生口角，产生隔阂，但大部分都充满着快乐。我们一起去走世界上最美的徒步路线，我们一起激流岛在海滩边上拍照，我们一起漫步在宫崎骏动画片里一样美的草地里，还有我们一起宅在家里的日日夜夜。</span>
         </p>
         <p><span>
            </span><span>我爱你盈盈，可能我的爱让你难以察觉，但是我一直用我力所能及的方式在爱你。可能确实有家庭后者南北方的差异，让我们对事情的看法和处理事情的方式有所不同。但是我从未觉得我们两个不合适，反而觉得差异才能摩擦出火花。我只是不习惯去表达自己爱，或者去解释我都是怎么爱你的。因为总觉得如果说了就像是在刻意邀功，想让你也多爱我一点。也觉得男人不应该儿女情长，要表现出一种不食人间烟火的样子，即使没有见到你的时候无时无刻不再想你的状态也不能让你知道。也觉得我的爱可能在我们之间的裂痕里是显得那么微不足道。很多时候我也会感到有些无力，感觉好多事情没有办法解决。我会选择用时间去稀释，让生活中温情的每个瞬间去融化那些问题。其实我想要的很简单，就是你能快乐，可持续的快乐。如果你能够快乐，我也快乐，那样我们才能一加一大于二。这些在你看来，可能是在不作为不付出。但是，我希望你能知道，我是一直在爱你的，爱你的一切，爱你一辈子。</span>
         </p>
         <p><span>
